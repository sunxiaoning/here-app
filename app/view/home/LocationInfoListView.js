Ext.define("here.view.home.LocationInfoListView",{
    ...
    initialize: function () {
        ...
        var store = Ext.create('Ext.data.Store',{
            autoLoad: false,
            fields: ['id', 'distance','publishTime','publishUser','locationDescribe','title'],
            pageSize:10,
            proxy: {
                id : 'infoListProxy',
                type: 'ajax',
                ...
                timeout : 10000,
                url: window.localStorage.getItem('SERVER_URL')+"/contentController/getLatestPublishContentListByLocationId",
                reader: {
                    type: 'json',
